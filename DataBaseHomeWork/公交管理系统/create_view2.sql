...
AS 
	SELECT sj.sj_id,sj.sex,sj.sj_name,t1.xl_id,cd_id,t1.xldz_id,cddz_id
...
CREATE OR REPLACE VIEW sj_xldz_cddz(sj_id,sj_name,xl_id,cd_id,cddz,xldz)
AS 
	SELECT ssj.sj_id,ssj.sj_name,ssj.xl_id,ssj.cd_id,sj1.sj_name,sj2.sj_name
	FROM sj_xl_cd ssj
...
AS 
	SELECT wz_name,sj_id,xl.xl_id,xl.cd_id,wzjl.TIME,wzjl.zd
